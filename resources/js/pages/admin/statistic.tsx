...
export default function Statistic() {
    return (
        <Layout title="Admin Dashboard - Statistic">
            <div className="flex w-full min-h-screen bg-[#172230] text-white">
                ...
                <aside className="w-84 border-r border-gray-700 bg-[#0f172a] px-4 py-8">
                    ...
                    <nav className="space-y-2 text-sm ">
                        <a href="/admin/statistic"><button className="mb-2 rounded-md w-76 text-left bg-gray-600 px-4 py-2 font-semibold text-white">Statistic</button></a>
                        <a href="/admin/users"><button className="mb-2 cursor-pointer w-76 text-left rounded-md px-4 py-2 hover:bg-gray-700">Users</button></a>
